                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-400 mt-0.5">
                        ...
                        Mejor:{" "}
                        <span className="font-semibold text-slate-600">{bestScore}/10</span>{" "}
                        · Media:{" "}
                        <span className="font-semibold text-slate-600">{avgScore}/10</span>
                      </p>
                    </div>
                  </div>
                  <div
                          ...
                          >
                            ...
                            <div className="flex items-center gap-3">
                              ...
                              <div
                                ...
                                style={{ transform: isSessionOpen ? "rotate(180deg)" : "rotate(0deg)" }}
                              >
