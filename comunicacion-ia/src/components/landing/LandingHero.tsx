    ...
    <section className="bg-gradient-to-b from-blue-950 to-blue-900 text-white border-b border-blue-950">
      <div className="max-w-5xl mx-auto px-6 py-24 md:py-32">
        <div className="max-w-3xl">
          <div className="inline-flex items-center gap-2 border border-blue-400/30 bg-blue-500/10 text-blue-200 px-3 py-1 rounded-sm text-xs font-medium uppercase tracking-widest mb-8">
          ...
          <p className="text-lg text-blue-100/80 mb-10 leading-relaxed max-w-2xl">
          ...
          <a
            href="#escenarios"
            className="inline-flex items-center gap-2 bg-white text-blue-950 px-6 py-3 rounded-sm font-semibold hover:bg-blue-50 transition"
          >
            Acceder al catálogo
